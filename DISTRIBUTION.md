...
```text
dist/Pasteboard-1.2.0-macOS.dmg
dist/Pasteboard-1.2.0-macOS.dmg.sha256
```
...
```bash
hdiutil verify "dist/Pasteboard-1.2.0-macOS.dmg"
shasum -a 256 "dist/Pasteboard-1.2.0-macOS.dmg"
shasum -a 256 -c "dist/Pasteboard-1.2.0-macOS.dmg.sha256"
```
