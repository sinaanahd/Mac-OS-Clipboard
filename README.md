...
Current version: **1.2.1** (build 6; baseline: 1.0.0). Ordinary publishable changes increment the patch component; substantial feature releases increment the minor component and reset patch to zero.
